...
- `-v` or `--verbose`: Prints details on doc generation progress instead of a
  progress bar.
- `--model`: Sets the LLM model to use. As of 5/25/2026, the default is Gemini
  3.5 Flash, which has a 1 million token context window, making it a great fit.
  You can try other Gemini models,
